...
class ImageRef(object):
    ...
    def id(self):
        ...
        Layered Insight ID for this image
    ...
    def name(self):
        """
        Gets the name of this ImageRef.
        Name of image

        :return: The name of this ImageRef.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this ImageRef.
        Name of image

        :param name: The name of this ImageRef.
        :type: str
        """
