...
from layint_scan_api.models.resource_not_found_error import ResourceNotFoundError
...
class TestResourceNotFoundError(unittest.TestCase):
    ...
    def testResourceNotFoundError(self):
        ...
        #model = layint_scan_api.models.resource_not_found_error.ResourceNotFoundError()
        pass
