...
from layint_scan_api.models.scan_datas import ScanDatas


class TestScanDatas(unittest.TestCase):
    """ ScanDatas unit test stubs """
    ...
    def testScanDatas(self):
        """
        Test ScanDatas
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = layint_scan_api.models.scan_datas.ScanDatas()
        pass
