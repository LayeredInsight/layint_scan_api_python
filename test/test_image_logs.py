...
from layint_scan_api.models.image_logs import ImageLogs


class TestImageLogs(unittest.TestCase):
    """ ImageLogs unit test stubs """
    ...
    def testImageLogs(self):
        """
        Test ImageLogs
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = layint_scan_api.models.image_logs.ImageLogs()
        pass
