...
from layint_scan_api.models.clair_layer import ClairLayer


class TestClairLayer(unittest.TestCase):
    """ ClairLayer unit test stubs """
    ...
    def testClairLayer(self):
        """
        Test ClairLayer
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = layint_scan_api.models.clair_layer.ClairLayer()
        pass
